...
// /***************************** Interval Functions
// *****************************/ var bridgeLeds =
// $('.bridge-window>canvas')[0].getContext('2d'); var countdownText =
// $('.bridge-window>h1'); var engineRoom = $('.rocket>.background:eq(0)'); var
// eyesRight = $('.brad-eyes.right'); var eyesLeft = $('.brad-eyes.left'); var
// titleSign = $('.title-sign-wrapper'); var particles =
// $('.particle-viewer-particles'); var particleImages =
// $('.particle-viewer-image'); var particleLightning =
// $('.particle-viewer-lightning'); var skillsWrapper = $('.skills-wrapper');
...
// **************************/ var changingProject = false; var countdownTime =
// -3; var currentBox = -1; var teleporting = false; var skillsClickedTimeout;
...
// /****************************** Scene Functions
// *******************************/ var animateLaunch = true; var
// countdownStarted = false; var countdownTimer; var disableWalking = false; var
// currentWalkingFrame = 0; var groundHeight = 0; var landerMastDeployed =
// false; var lastPositionBrad = 0; var lastAdjustedSceneX =
// $(document).scrollTop(); var moving = false; var rocketLaunched = false; var
// screenHeight = 0; var speedScene = 1 / 1; var speedBackground = 1 / 2; var
// speedFarBackground = 1 / 3; var speedSuperFarBackground = 1 / 10; var
// stopWalkingTimeout; var timingWalking = 200;
...
//     cssPrefix(
//         shuttleDoorBottom, 'transform', 'rotateX(-180deg)
//         perspective(600px)');
//   } else {
//     cssPrefix(shuttleDoorTop, 'transform', 'rotateX(0deg)
//     perspective(600px)'); cssPrefix(shuttleDoorBottom, 'transform',
//     'rotateX(0deg) perspective(600px)');
//   }
...
//   // Move Brad
//   var positionBrad = (-bradContainer.width() / 2) - Math.max(positionScene,
//   0); positionBrad +=
